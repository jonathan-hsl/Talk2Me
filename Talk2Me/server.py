...
class State(rx.State):
    ...
    def run(self, persona):
        ...
        summaries = {
            ...
            "date": "You are a woman on a date. You are going to ask questions and carry a conversation like two people on a date normally would. Use the user responses to inform your statements and questions. At the end, when the user says 'done', give a brief critique of their performance and what they can work on.",
